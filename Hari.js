                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box755"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Hari Burger</div>
                            <div className="box777">Quick Bites - Fast Food, Chinese, Italian, Beverages</div>
                            <div className="box888">
                                <div className="box999">120 Feet Road, Near Lucky General Store</div>
                            </div>
