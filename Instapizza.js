...
import './Burgrill.css'
import './Myfourth.css'
import './Instapizza.css'

function Instapizza(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box770"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Instapizza</div>
                            <div className="box777">Quick Bites - Pizza, Fast Food, Italian, Desserts</div>
                            <div className="box888">
                                <div className="box999">Booth 91 & 92 ,Major Raman Complex</div>
                            </div>
