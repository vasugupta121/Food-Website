                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box716"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Goli Vada Pav No 1</div>
                            <div className="box777">Quick Bites - North Indian, Snacks, Fast Food, Street Food</div>
                            <div className="box888">
                                <div className="box999">Model Town, South_Jalandhar</div>
                            </div>
