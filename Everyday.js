                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box723"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Everyday Fresh</div>
                            <div className="box777">Quick Bites - Healthy Food, Salad, Wraps, Burger, Sandwich, Beverages</div>
                            <div className="box888">
                                <div className="box999">192 L, Basement, Model Town</div>
                            </div>
