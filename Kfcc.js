                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box714"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">KFC</div>
                            <div className="box777">Quick Bites - Burger, Fast Food, Finger Food, Beverages</div>
                            <div className="box888">
                                <div className="box999">Rampa Centre Point, Model Town Market</div>
                            </div>
