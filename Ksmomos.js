                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box711"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">K.S.Momos</div>
                            <div className="box777">Quick Bites - Momos, Chinese, Rolls, Fast Food, Street Food</div>
                            <div className="box888">
                                <div className="box999">Shop 272 Japp Tower, Model Town</div>
                            </div>
