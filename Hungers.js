                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box843"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Hunger's Villa</div>
                            <div className="box777">Quick Bites - Desserts, Bakery, Street Food, Burger, Sandwich, Beverages</div>
                            <div className="box888">
                                <div className="box999">Rama Mandi Chowk, Near Bus Stand</div>
                            </div>
