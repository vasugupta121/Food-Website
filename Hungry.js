                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box767"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Hungry Kya </div>
                            <div className="box777">Quick Bites - North Indian, Healthy Food, Pizza, Burger, Beverage</div>
                            <div className="box888">
                                <div className="box999">197, Master Tara Singh Nagar</div>
                            </div>
