                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box773"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Frozen N Fry</div>
                            <div className="box777">Quick Bites - Italian, Fast Food</div>
                            <div className="box888">
                                <div className="box999">1, Mahaveer Marg Adarsh Nagar</div>
                            </div>
