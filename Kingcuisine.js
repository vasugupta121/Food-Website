...
import './Burgrill.css'
import './Myfourth.css'
import './Kingcuisine.css'

function Kingcuisine(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box869"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">King Cuisine Car</div>
                            <div className="box777">Food Truck - North Indian, Fast Food, South Indian, Chinese, Continental</div>
                            <div className="box888">
                                <div className="box999">Plot 2, Near Nanda Dharam Kanda</div>
                            </div>
