                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box818"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Ganpati Vaishno Dhaba</div>
                            <div className="box777">Quick Bites - North Indian, Biryani, Chinese, Desserts, Beverages</div>
                            <div className="box888">
                                <div className="box999">Prince Plaza, Mithapur Road, Near Axis</div>
                            </div>
