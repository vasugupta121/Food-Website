                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box720"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Hot Drive</div>
                            <div className="box777">Quick Bites - North Indian, Continental, Chinese, Afghan</div>
                            <div className="box888">
                                <div className="box999">Nikku Park Road, Model Town Market</div>
                            </div>
