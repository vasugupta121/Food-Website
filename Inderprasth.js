...
import './Burgrill.css'
import './Myfourth.css'
import './Inderprasth.css'

function Inderprasth(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box871"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Inderprasth Khana Khazana</div>
                            <div className="box777">Quick Bites - North Indian, Chinese, Fast Food, Desserts, Beverages</div>
                            <div className="box888">
                                <div className="box999">120 Feet Road, Babrik Chownk</div>
                            </div>
