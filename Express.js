                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box730"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Express Vegetarian</div>
                            <div className="box777">Casual Dining - North Indian</div>
                            <div className="box888">
                                <div className="box999">New Jawahar Nahar, Model Town</div>
                            </div>
