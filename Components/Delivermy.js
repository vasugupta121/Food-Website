...
import './Burgrill.css'
import './Myfourth.css'
import './Delivermy.css'

function Delivermy(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box861"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Deliver My Ice-Cream</div>
                            <div className="box777">Dessert Parlor - Ice Cream, Desserts, Beverages</div>
                            <div className="box888">
                                <div className="box999">NC-44, Kot Kishan Chand</div>
                            </div>
