                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box812"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Chaska Dhaba</div>
                            <div className="box777">Quick Bites - North Indian, Chinese, Beverages</div>
                            <div className="box888">
                                <div className="box999">SCF-72, Urban Estate Phase - 1</div>
                            </div>
