...
import './Burgrill.css'
import './Myfourth.css'
import './Amritsari.css'

function Amritsari(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box756"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Amritsari Lovely Dhaba</div>
                            <div className="box777">Casual Dining -North Indian, Chinese, Biryani, Desserts</div>
                            <div className="box888">
                                <div className="box999">Basti Adda Road, Near Football Chowk</div>
                            </div>
