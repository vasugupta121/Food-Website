...
import './Burgrill.css'
import './Myfourth.css'
import './Biryanibykilo.css'

function Biryanibykilo(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box821"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Biryani By Kilo</div>
                            <div className="box777">Casual Dining - Biryani, Mughlai, Kebab</div>
                            <div className="box888">
                                <div className="box999">SCO 7, Ground Floor, Crystal Plaza</div>
                            </div>
