                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box850"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Bombay Delight</div>
                            <div className="box777">Quick Bites - Maharashtrian, Chinese, Fast Food, Continental</div>
                            <div className="box888">
                                <div className="box999">JHC Complex, Ladhewali Chowk</div>
                            </div>
