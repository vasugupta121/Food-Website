                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box820"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Diet Hut</div>
                            <div className="box777">Quick Bites - Italian, Fast Food, Chinese, Continental, North Indian</div>
                            <div className="box888">
                                <div className="box999">SCO 3A, Near Curo , Main 66 Feet Road</div>
                            </div>
