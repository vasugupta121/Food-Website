...
import './Burgrill.css'
import './Myfourth.css'
import './Ampmbakers.css'

function Ampmbakers(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box849"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">AM PM Bakers</div>
                            <div className="box777">Bakery - Bakery</div>
                            <div className="box888">
                                <div className="box999">Near Rama Mandi Chowk</div>
                            </div>
