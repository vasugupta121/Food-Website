                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box722"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">The Belgian Waffle Co.</div>
                            <div className="box777">Desserts</div>
                            <div className="box888">
                                <div className="box999">398 L, Model Town</div>
                            </div>
