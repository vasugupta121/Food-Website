...
import './Burgrill.css'
import './Myfourth.css'
import './Deenanathji.css'

function Deenanathji(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box859"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Deenanath Special Cholle Kulche</div>
                            <div className="box777">Quick Bites - Street Food</div>
                            <div className="box888">
                                <div className="box999">Opposite DAV College, Under Flyover</div>
                            </div>
