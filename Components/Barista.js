                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box826"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Barista Cafe & Lounge</div>
                            <div className="box777">Cafe - Cafe, Sandwich, Rolls, Wraps, Desserts, Italian, Pizza, Beverages</div>
                            <div className="box888">
                                <div className="box999">SCO 85, First Floor, Phase 2 Market</div>
                            </div>
