                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box774"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Chick Chick</div>
                            <div className="box777">Quick Bites - North Indian, Mughlai</div>
                            <div className="box888">
                                <div className="box999">Mahavir Marg, Krishna Nagar</div>
                            </div>
