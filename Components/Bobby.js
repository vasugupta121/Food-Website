                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box739"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">New Bobby Veg & Non</div>
                            <div className="box777">Quick Bites - North Indian, Biryani, Chinese, Fast Food</div>
                            <div className="box888">
                                <div className="box999">Johal Market, Model Town, Jalandhar</div>
                            </div>
