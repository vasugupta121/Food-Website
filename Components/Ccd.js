                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box804"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Cafe Coffee Day</div>
                            <div className="box777">Café - Beverages, Cafe, Sandwich, Fast Food, Desserts, Coffee</div>
                            <div className="box888">
                                <div className="box999">BPCL Outlet, BMC Chowk</div>
                            </div>
