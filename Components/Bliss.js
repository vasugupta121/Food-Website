                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box726"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Bliss Vaishno Dhaba</div>
                            <div className="box777">Dhaba - North Indian, Desserts, Beverages, Biryani, Continental</div>
                            <div className="box888">
                                <div className="box999">179, Civil Lines, Opposite District Court</div>
                            </div>
