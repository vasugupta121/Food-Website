...
import './Burgrill.css'
import './Myfourth.css'
import './Biryanidilse.css'

function Biryanidilse(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box837"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Biryani Dil Se!</div>
                            <div className="box777">Biryani, North Indian, Awadhi</div>
                            <div className="box888">
                                <div className="box999">Near Lamba Pind Chowk, Purani Chowki 8</div>
                            </div>
