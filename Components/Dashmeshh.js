...
import './Burgrill.css'
import './Myfourth.css'
import './Dashmeshh.css'

function Dashmeshh(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box842"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Dashmesh Vaishno Dhaba</div>
                            <div className="box777">North Indian</div>
                            <div className="box888">
                                <div className="box999">Hoshiarpur Road, Rama Mandi</div>
                            </div>
