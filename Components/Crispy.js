                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box845"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">The Crispy Hawkers</div>
                            <div className="box777">Casual Dining - Burger, Chinese, Beverages, Italian</div>
                            <div className="box888">
                                <div className="box999">Opp HDFC Bank, Rama Mandi</div>
                            </div>
