...
import './Burgrill.css'
import './Myfourth.css'
import './Burgerland.css'

function Burgerland(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box879"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Burger's Land</div>
                            <div className="box777">Quick Bites - Fast Food, Burger, Chinese</div>
                            <div className="box888">
                                <div className="box999">56 R, Block A, Model House,</div>
                            </div>
