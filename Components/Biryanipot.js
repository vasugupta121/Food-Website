...
import './Burgrill.css'
import './Myfourth.css'
import './Biryanipot.css'

function Biryanipot(props) {
    return(
        <div>
             <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box735"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Biryani Pot</div>
                            <div className="box777">Biryani</div>
                            <div className="box888">
                                <div className="box999">38, Basti Sheikh, Near Post Office</div>
                            </div>
