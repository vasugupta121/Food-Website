...
import './Burgrill.css'
import './Myfourth.css'
import './Burgeradda.css'

function Burgeradda(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box771"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Burger Adda</div>
                            <div className="box777">Quick Bites - Burger, Pizza, Chinese</div>
                            <div className="box888">
                                <div className="box999">Shop 16, First Floor, Kfort Market, Gurjeet Nagar</div>
                            </div>
