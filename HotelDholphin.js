...
import './Burgrill.css'
import './Myfourth.css'
import './HotelDholphin.css'

function HotelDholphin(props) {
    return(
        <div>
              <div className="g9">
                ...
                <div className="box111">
                    <div className="box222">
                        <div className="box333">
                            <div className="box738"></div>
                        </div>
                        <div className="box555">
                            <div className="box666">Hotel Dolphin</div>
                            <div className="box777">Fine Dining - North Indian, Fast Food, South Indian, Chinese, Continental</div>
                            <div className="box888">
                                <div className="box999">G.T Road, Near Patel Chowk,Model Town</div>
                            </div>
